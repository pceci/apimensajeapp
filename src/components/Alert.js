...
export default function Alert(props) {
    ...
    const handleCerrarAlert = () => {  setIsAlert(false); }
    return (<div className={"alert alert-warning alert-dismissible fade show " + (isAlert ? 'Alert_block' : 'Alert_none')} role="alert">
        <div>
